...
public class MainState
{
    ...
    public virtual void PhysicsCheck()
    {
        ...
        // Для 3D нужно использовать 3D методы получения контактов
        // Замените на соответствующий 3D метод
        ...
        // Для 3D нужно адаптировать проверку углов
        ...
        // Исправление: преобразуем Vector2 в Vector3 для 3D физики
