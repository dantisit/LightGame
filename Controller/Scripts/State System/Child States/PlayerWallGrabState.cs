...
public class PlayerWallGrabState : MainState, IMove1D
{
    ...
    public override void Enter()
    {
        ...
        curveTime = EssentialPhysics.SetCurveTimeByValue(playerData.Walls.WallGrab.SlowDownCurve, Mathf.Abs(rigidbody.linearVelocity.y) / playerData.Walls.WallClimb.MaxSpeed, 1f, false);
