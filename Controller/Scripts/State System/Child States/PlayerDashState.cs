...
public class PlayerDashState : MainState, IMove2D
{
    ...
    {
        base.Enter();
        rigidbody.gravityScale = playerData.Dash.Physics2DGravityScale;
    ...
    public override void SwitchStateLogic()
    {
        ...
        if(localTime > playerData.Dash.DashTime)
        {
            ...
            else if (rigidbody.linearVelocity.y == 0 && inputManager.Input_Walk == 0 && playerData.Physics.IsGrounded && (!playerData.Physics.IsOnNotWalkableSlope))
            {
    ...
    public void Move2D()
    {
        ...
        rigidbody.linearVelocity = XVelocity;
    }
}
