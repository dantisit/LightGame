...
namespace EasyTextEffects
{
    ...
    {
        /// <summary>
        /// Fired when a character starts its animation
        /// </summary>
        public event Action<int> OnCharacterStart;
        
        internal void InvokeCharacterStart(int charIndex)
        {
            OnCharacterStart?.Invoke(charIndex);
        }
        ...
        private void CopyGlobalEffects(TMP_TextInfo textInfo)
        {
            ...
            globalEffects.ForEach(_entry =>
            {
                ...
                effectEntry.effect.SetTextEffect(this); // Pass TextEffect reference
        ...
        private void AddTagEffects(TMP_LinkInfo[] styles, int linkCount)
        {
            ...
            for (var i = 0; i < linkCount; i++)
            {
                ...
                foreach (TextEffectEntry entry in effectTemplates)
                {
                    ...
                    entryCopy.effect.SetTextEffect(this); // Pass TextEffect reference
