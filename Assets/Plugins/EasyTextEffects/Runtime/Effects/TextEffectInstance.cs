...
namespace EasyTextEffects.Effects
{
    public abstract class TextEffectInstance : TextEffect_Base
    {
        ...
        // Reference to parent TextEffect
        private EasyTextEffects.TextEffect parentTextEffect;

        public virtual void SetTextEffect(EasyTextEffects.TextEffect textEffect)
        {
            parentTextEffect = textEffect;
        }
        
        protected void FireCharacterStartEvent(int _charIndex)
        {
            parentTextEffect?.InvokeCharacterStart(_charIndex);
        }
